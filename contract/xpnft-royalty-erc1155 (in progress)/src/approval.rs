...
pub trait MultiTokenCore {
    ...
    fn mt_is_approved(
        ...
        amounts: Vec<String>,
        approval_ids: Vec<Option<String>>,
    ) -> bool;
...
trait MultiTokenApprovalsReceiver {
...
impl MultiTokenCore for Contract {
    ...
    fn mt_approve(
        ...
        */
        ...
        let mut token = self.tokens_by_id.get(&token_ids[0]).expect("No token");
        ...
        self.tokens_by_id.insert(&token_ids[0], &token);
    ...
    fn mt_is_approved(
        ...
        let token = self.tokens_by_id.get(&token_ids[0]).expect("No token");
        ...
        if let Some(approval) = approval {
            ...
            if let Some(approval_id) = approval_ids[0] {
